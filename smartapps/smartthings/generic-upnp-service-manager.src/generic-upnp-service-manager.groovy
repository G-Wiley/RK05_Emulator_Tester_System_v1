...
def addDevices() {
	...
	selectedDevices.each { dni ->
		...
		if (!d) {
			...
			addChildDevice("bfindley", "Sprinkler Controller with Display", selectedDevice.value.mac, selectedDevice?.value.hub, [
				"label": selectedDevice?.value?.name ?: "ESP Controller",
				"data": [
